/**
 * Login view — Google sign-in screen.
 */
import { loginWithGoogle } from '@js/services/firebase.js';
...
export function mount() {
  ...
  const handleClick = async (e) => {
    ...
    if (btn.dataset.action === 'login-google') {
      btn.disabled = true;
      ...
      try {
        ...
        // Try to download existing cloud data
        const hadData = await downloadAllData();
