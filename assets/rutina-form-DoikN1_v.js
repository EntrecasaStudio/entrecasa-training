import{u as L,n as k,g as N,H as R,h as A,I as T,J as D,p as H,K as q,i as $}from"./index-BTNJYZkc.js";const K=["Pecho","Espalda","Piernas","Core","Brazos","Glúteos","Hombros"],U=2,C=4,E=6,I=15,M={Pecho:["Pecho"],Espalda:["Espalda"],Piernas:["Piernas","Glúteos"],Core:["Core"],Brazos:["Brazos","Hombros"],Glúteos:["Glúteos"],Hombros:["Hombros"]};function S(){return{id:R(),nombre:"",repsObjetivo:10,pesoKg:0}}function B(){return{id:R(),grupoMuscular:"Pecho",ejercicios:[S(),S()]}}let i=null,r=null,l="",b=!1;function _(a,e){const t=i.circuitos[a],s=M[t.grupoMuscular]||[t.grupoMuscular],m=q(s,l),n=l.trim().toLowerCase(),c=n&&m.some(o=>o.nombre.toLowerCase()===n),v=m.map(o=>`
