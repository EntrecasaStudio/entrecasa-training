import{p as A,L as g,a as M,u as q,n as E,x as B,g as C,H as D,M as P,N as F}from"./index-BTNJYZkc.js";import{f as T}from"./stats-helpers-DiYvjblw.js";let w=null;function W(){return w||(w=new(window.AudioContext||window.webkitAudioContext)),w}function L(t=880,e=.15){try{const s=W(),r=s.createOscillator(),i=s.createGain();r.type="sine",r.frequency.value=t,i.gain.value=.3,i.gain.exponentialRampToValueAtTime(.001,s.currentTime+e),r.connect(i),i.connect(s.destination),r.start(s.currentTime),r.stop(s.currentTime+e)}catch{}}function N(){L(660,.08)}function z(){L(988,.25)}let o=null,k=null,d=null,p=0;const y=[1,2.5,5],h=[60,90,120];let S=1,R=1;function H(t){const e=M();if(e&&e.rutinaId===t){o=e;return}const s=q(t);if(!s){E("/");return}const r=B(s.id),i={};r&&r.circuitos.forEach(a=>{a.ejercicios.forEach(c=>{i[c.nombre]={reps:c.repsReal,peso:c.pesoRealKg}})}),o={rutinaId:s.id,rutinaNombre:s.nombre,usuario:s.usuario||C(),inicioISO:new Date().toISOString(),circuitoActual:0,resultados:s.circuitos.map(a=>({grupoMuscular:a.grupoMuscular,ejercicios:a.ejercicios.map(c=>{const n=i[c.nombre];return{nombre:c.nombre,repsObjetivo:c.repsObjetivo,repsReal:n?n.reps:c.repsObjetivo,pesoObjetivoKg:c.pesoKg,pesoRealKg:n?n.peso:c.pesoKg}})}))},g(o)}function O(){if(!o)return"00:00";const t=new Date(o.inicioISO),e=Math.floor((Date.now()-t.getTime())/1e3),s=Math.floor(e/60),r=e%60;return`${String(s).padStart(2,"0")}:${String(r).padStart(2,"0")}`}function _(){const t=o.resultados.length,e=o.circuitoActual/t*100,s=o.resultados.map((r,i)=>{let a="workout-progress-dot";return i<o.circuitoActual?a+=" done":i===o.circuitoActual&&(a+=" current"),`<span class="${a}"></span>`}).join("");return`
  ...
  `}function J(t){if(H(t.id),!o)return"";const e=o.resultados[o.circuitoActual],s=o.circuitoActual===o.resultados.length-1,r=e.ejercicios.map((i,a)=>V(i,a)).join("");return`
